...
namespace Terraria
{
	public class Projectile : Entity
	{
		...
		public void ghostHeal(int dmg, Vector2 Position)
		{
            ...
            if (num2 > (float)Main.player[this.owner].statLifeMax3 * 0.08f)
                num2 = (float)Main.player[this.owner].statLifeMax3 * 0.08f;
            if ((int)num2 <= 0)
			{
				return;
			}
		...
		public void vampireHeal(int dmg, Vector2 Position)
        {
            ...
            if (num > (float)Main.player[this.owner].statLifeMax3 * 0.08f)
                num = (float)Main.player[this.owner].statLifeMax3 * 0.08f;
            if ((int)num == 0)
            {
                return;
            }
			...
			while (this.numUpdates >= 0)
			{
				...
				else
				{
						...
						if (((this.type != 440 && this.type != 449 && this.type != 606) || this.ai[1] != 1f) && (this.type != 466 || this.localAI[1] != 1f) && (this.type != 580 || this.localAI[1] <= 0f) && (this.type != 640 || this.localAI[1] <= 0f))
						{
							...
							else
							{
								...
								else
								{
									...
									if (!Main.projPet[this.type])
									{
										Vector4 vector2 = Collision.SlopeCollision(position, this.velocity, num27, num28, 0f, true);
										Vector2 vector3 = this.position - position;
										...
										if (this.velocity.X != vector2.Z)
										{
											flag3 = true;
										}
										if (this.velocity.Y != vector2.W)
										{
											flag3 = true;
										}
							...
							else if (!Main.projPet[this.type] && this.type != 500 && this.type != 650)
							{
								if (this.aiStyle == 99)
								{
									if (this.type >= 556 && this.type <= 561)
									{
										...
										if (flag8)
										{
											Vector2 vector5 = Main.player[this.owner].Center - base.Center;
											vector5.Normalize();
									...
									if (this.type == 477)
									{
										...
										if (this.penetrate > 0 && this.owner == Main.myPlayer)
										{
											...
											if (num37 > 0)
											{
												...
												Vector2 vector6 = Main.npc[array[num37]].Center - base.Center;
												float num42 = this.velocity.Length();
												vector6.Normalize();
												this.velocity = vector6 * num42;
												this.netUpdate = true;
											}
										}
									}
					...
					if (this.aiStyle != 4 && this.aiStyle != 38 && this.aiStyle != 84 && (this.aiStyle != 7 || this.ai[0] != 2f) && ((this.type != 440 && this.type != 449 && this.type != 606) || this.ai[1] != 1f) && (this.aiStyle != 93 || this.ai[0] >= 0f) && this.type != 540)
					{
						...
						{
							Vector4 vector7 = Collision.SlopeCollision(this.position, this.velocity, this.width, this.height, 0f, false);
							this.position.X = vector7.X;
							this.position.Y = vector7.Y;
